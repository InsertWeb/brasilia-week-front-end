...
import "../../../components/utils/truncatStyle.css";
export function AdminParceiros() {
  ...
  return (
    <div className="bg-white rounded-lg sm:p-5 space-y-5">
              ...
              <>
                {parceiros?.data.map((e) => (
                  <tr key={e.id} className="align-middle text-sm">
                    ...
                    <td className="px-4 py-2">
                      {" "}
                      <p className="truncated-text">{e.title_pt}</p>
                    </td>
                    <td className="px-4 py-2">
                      {" "}
                      <p className="truncated-text">{e.title_en}</p>
                    </td>
                    <td className="px-4 py-2">
                      <p className="truncated-text">{e.descricao_pt}</p>
                    </td>
                    <td className="px-4 py-2">
                      <p className="truncated-text">{e.descricao_en}</p>
                    </td>
